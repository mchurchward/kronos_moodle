...
/**
 * The kronosportal_userset_not_found event class.
 *
 * @property-read array $other {
 *
 *      The user's Solutions ID (level 2 User Set) does not exist/
 * }
 *
 */
class kronosportal_userset_not_found extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventkronosportal_userset_not_found', 'auth_kronosportal');
    }
