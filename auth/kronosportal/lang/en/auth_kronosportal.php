...
$string['eventkronosportal_learningpath_not_exist'] = 'Learning Path does not exist.';
$string['eventkronosportal_elisuser_not_created'] = 'ELIS User could not be found.';
...
$string['wfc_auth_error_learning_path_not_exist'] = 'Unable to create account, Learning Path could not be found. Please contact your administrator.';
$string['wfc_auth_error_could_not_find_elis_user'] = 'Unable to create account. Error code: 0100. Please contact your administrator.';
