YUI.add('moodle-block_importqueue-usrsetautocmp', function (Y, NAME) {
...
{
    NAME: 'moodle-block_importqueue-usrsetautocmp',
    ATTRS: {
        datasource: {
           value: ''
        },
...
M.block_importqueue = M.block_importqueue || {};
 ...
 */
M.block_importqueue.init = function(params) {
