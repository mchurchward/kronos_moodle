...
/**
 * User Set HTML block.  This file processes AJAX actions and returns JSON for the User Set HTML User Set auto-complete.
 *
...
$PAGE->set_url(new moodle_url('/blocks/usersethtml/ajax.php', array('usrset' => $query)));

require_login(null, false);
require_capability('block/usersethtml:selectuserset', context_block::instance($contextid));
