 ...
 */
class block_usersethtml extends block_base {
    /**
    ...
    public function specialization() {
        $this->title = isset($this->config->title) ? format_string($this->config->title) : format_string(get_string('newusersethtml', $this->blockname));
    }
    ...
    public function get_content() {
        ...
        if (isset($this->config->text)) {
            // Rewrite url.
            $this->config->text = file_rewrite_pluginfile_urls($this->config->text, 'pluginfile.php', $this->context->id, 'block_usersethtml', 'content', null);
