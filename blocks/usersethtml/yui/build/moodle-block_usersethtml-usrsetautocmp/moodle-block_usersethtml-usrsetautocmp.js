YUI.add('moodle-block_usersethtml-usrsetautocmp', function (Y, NAME) {
...
{
    NAME: 'moodle-block_usersethtml-usrsetautocmp',
    ATTRS: {
        datasource: {
           value: ''
        },
...
M.block_usersethtml = M.block_usersethtml || {};
 ...
 */
M.block_usersethtml.init = function(params) {
