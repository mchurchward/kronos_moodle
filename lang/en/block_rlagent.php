...
$string['add_or_update_rating_normal'] = 'for this plugin';
...
$string['dependency_will_be_added'] = 'The following dependency of {$a->source} will be added: {$a->target}.';
...
$string['plugin_description_not_available'] = 'Plugin description not available.';
$string['plugin_name_not_available'] = 'Plugin name not available.';
$string['plugins_will_be_added'] = 'The following plugins will be added:';
$string['plugins_will_be_updated'] = 'The following plugins will be updated:';
$string['plugins_will_be_removed'] = 'The following plugins will be removed:';
...
$string['title_upgradeable'] = 'Upgradeable';
...
$string['update_selected_plugins'] = 'Update/Install/Remove Selected Plugins';
