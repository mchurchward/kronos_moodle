...
{$a->log}';
$string['error'] = 'Error';
$string['error_add_installed'] = 'Addon {$a} is already installed.  Skipping addition.';
...
$string['error_remove_notinstalled'] = 'Addon {$a} is not present.  Skipping removal';
$string['error_update_added'] = 'A new version of {$a} will be added, no further update possible.  Skipping update.';
$string['error_update_not_installled'] = 'Addon {$a} is not installed and thus can\'t be updated.  Skipping update.';
$string['error_update_removed'] = 'The {$a} addon will be removed and thus can\'t be updated.  Skipping update.';
...
$string['error_unknown_addon'] = 'Unknown addon: {$a}.  Skipping.';
$string['error_unknown_addon_type'] = 'Unknown addon type: {$a->type} for addon {$a->name}.  Skipping.';
$string['error_unparseable_name'] = "Action: $action - unrecognizable addon name: $item.  Skipping.";
...
$string['trusted_addons_only'] = 'Hide unreviewed add-ons';
