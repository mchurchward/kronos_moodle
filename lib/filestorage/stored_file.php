...
class stored_file {
    ...
    */
    ...
    public function get_status() {
        // RL EDIT: sets repository/elis_files file's status to zer
        $src = !empty($this->file_record->source) ? @unserialize($this->file_record->source) : new stdClass;
        if (!empty($src->source) && strpos($src->source, '/') === false) {
            // error_log("/lib/filestorage/stored_file.php::get_status(): INFO:
