        ...
        if (strpos($component, 'core_') === 0) {
            ...
            switch($component) {
                case 'core_filepicker':
                    ...
                    // RL EDIT: BJB140922
                    if (file_exists($CFG->dirroot.'/repository/elisfiles/lang/en/repository_elisfiles.php')) {
                        $elisfilesstrings = array(
                        ...
                        $module['strings'] = array_merge($module['strings'], $elisfilesstrings);
                    }
                    // End RL EDIT
                    break;
                case 'core_comment':
