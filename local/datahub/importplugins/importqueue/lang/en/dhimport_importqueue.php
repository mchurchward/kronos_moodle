...
$string['configemailnotification'] = 'A comma-separated list of email addresses to send import log files to.';
$string['debugnotification'] = 'Debug notification';
$string['configdebugnotification'] = 'A comma-separated list of email addresses to send debug related emails.';
$string['email_debug_error_from'] = 'DH Import Queue';
$string['email_debug_error_subject'] = 'Import Queue Error (Queue ID: {$a->queueid})';
$string['email_debug_error_message'] = 'There was an error processing queue ID {$a->queueid} on site {$a->wwwroot}';
