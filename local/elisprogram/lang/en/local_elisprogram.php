...
$string['ds_action_unassign_confirm_cascade'] = 'Are you sure you want to unassign this {$a->actionelement} from the {$a->baseelement}? You will not be able to recover grade data. Please go to {$a->reportlink} and make a copy of the data.';
$string['ds_action_unassign_confirm_multi'] = 'Are you sure you want to unassign these {$a->actionelement} from the {$a->baseelement}?';
$string['ds_action_unassign_confirm_multi_cascade'] = 'Are you sure you want to unassign these {$a->actionelement} from the {$a->baseelement}?  You will not be able to recover grade data. Please go to {$a->reportlink} and make to make a copy of the data.';
