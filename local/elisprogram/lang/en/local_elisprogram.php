...
$string['add_courseset'] = 'Add Course Set';
...
$string['courseset_idnumber'] = 'ID Number';
$string['courseset_name'] = 'Name';
$string['coursesetform:courseset_description'] = 'Description';
$string['coursesetform:courseset_description_help'] = '<p>Description information about the Course Set.</p>';
$string['coursesetform:courseset_idnumber'] = 'ID Number';
$string['coursesetform:courseset_idnumber_help'] = '<p>Course Set ID number. This number will display in reports.</p>';
$string['coursesetform:courseset_name'] = 'Name';
$string['coursesetform:courseset_name_help'] = '<p>Name of Course Set.</p>';
...
$string['delete_courseset'] = 'Delete Course Set';
...
$string['ds_action_unassign_confirm_cascade'] = 'Are you sure you want to unassign this {$a->actionelement} from the {$a->baseelement}? If you want a user activity record before you complete this action, click to display the {$a->reportlink}.';
$string['ds_action_unassign_confirm_multi'] = 'Are you sure you want to unassign these {$a->actionelement} from the {$a->baseelement}?';
$string['ds_action_unassign_confirm_multi_cascade'] = 'Are you sure you want to unassign these {$a->actionelement} from the {$a->baseelement}?  If you want a user activity record before you complete this action, click to display the {$a->reportlink}.';
...
$string['ds_action_usersetsubset_delete'] = 'You are about to delete the User Subset, proceed?';
$string['ds_action_usersetsubsets_delete'] = 'You are about to delete the User Subsets, proceed?';
...
$string['elisprogram:courseset_create'] = 'Add course set';
$string['elisprogram:courseset_delete'] = 'Delete course set';
$string['elisprogram:courseset_delete_active'] = 'Delete active course set';
$string['elisprogram:courseset_edit'] = 'Edit course set';
$string['elisprogram:courseset_edit_active'] = 'Edit active course set';
$string['elisprogram:courseset_view'] = 'View course set';
...
$string['elisprogram:userset_associateprogram'] = 'Associate any Program to User Set';
$string['elisprogram:userset_associatetrack'] = 'Associate any Track to User Set';
...
$string['elisprogram:userset_subsetadd'] = 'Create User Subsets';
$string['elisprogram:userset_subsetedit'] = 'Edit User Subsets';
$string['elisprogram:userset_subsetdelete'] = 'Delete User Subsets';
...
$string['elisprogram:searchloadparent'] = 'Can load deepsight searches of the parent userset';
$string['elisprogram:searchload'] = 'Can load deepsight searches';
$string['elisprogram:searchsave'] = 'Can save deepsight searches';
...
$string['search_form_saving'] = 'Saving...';
$string['search_form_name'] = 'Search name';
$string['search_form_default'] = 'Save as default search';
$string['search_form_save'] = 'Save';
$string['search_form_save_copy'] = 'Save a copy';
$string['search_form_save_error'] = 'There was an error saving the search, please try again.';
$string['search_form_name_error'] = 'Please enter a name for your search.';
$string['search_form_saved'] = 'Search saved.';
$string['search_form_save_title'] = 'Save search';
$string['search_setdefault_saved'] = 'Your search has been saved as the default search.';
$string['search_for'] = 'Searching for';
$string['search_noresults'] = 'No saved searches found.';
$string['search_tools'] = 'Tools &#x25BC;';
$string['search_load'] = 'Load search';
$string['search_delete'] = 'Delete search';
$string['search_delete_confirm'] = 'Are you sure you want to delete your search ?';
$string['search_deleted'] = 'Your search has been deleted.';
$string['search_save'] = 'Save search';
$string['search_setdefault'] = 'Set as default search';
$string['search_clearsearch'] = 'Start new search';
$string['search_loadtitle'] = 'Load search';
$string['search_toolstitle'] = 'Tools';
$string['search_deletetitle'] = 'Delete A Search';
$string['search_savetitle'] = 'Save A Search';
$string['search_addtitle'] = 'Add A Search';
...
$string['manage_courseset'] = 'Manage Course Sets';
...
$string['managecoursesets'] = 'Manage Course Sets';
...
$string['notice_courseset_deleted'] = 'Deleted the course set named {$a->name} (ID number: {$a->idnumber})';
...
$string['num_courseset_found'] = '{$a->num} course set(s) found';
$string['num_coursesets'] = 'Num Course Sets';
...
$string['usersetprogramform:autoassoc'] = 'Auto-Associate';
$string['usersetprogramform:autoassoc_help'] = '<p>If this box is checked then any User Subsets not associated will be associated.</p>';
$string['usersetprogramform_autoassoc'] = 'Associate any unassociated User Subsets';
...
$string['usersetprogramform:recursive'] = 'Recursive';
$string['usersetprogramform:recursive_help'] = '<p>If this box is checked then these Userset associations will be applied to all User Subsets as well.</p>';
$string['usersetprogramform_recursive'] = 'Apply Program association to all User Subsets';
$string['usersetprogramform_recursive_edit'] = 'Apply Program association change to all associated User Subsets';
$string['usersetprogramform_recursive_unassign'] = 'Apply Program unassociation to all User Subsets';
...
$string['userset_classification_nameunique'] = 'User Set Classification Name already exists, must be unique.';
$string['userset_classification_shortnameunique'] = 'User Set Classification Shortname already exists, must be unique.';
...
$string['usersettrackform:autoassoc'] = 'Auto-Associate';
$string['usersettrackform:autoassoc_help'] = '<p>If this box is checked then any User Subsets not associated will be associated.</p>';
...
$string['usersettrackform:recursive'] = 'Recursive';
$string['usersettrackform:recursive_help'] = '<p>If this box is checked then these associations will be applied to all User Subsets as well.</p>';
$string['usersettrack_autoassoc'] = 'Associate any unassociated User Subsets';
$string['usersettrack_recursive'] = 'Apply Track association to all User Subsets';
$string['usersettrack_recursive_edit'] = 'Apply Track association change to all associated User Subsets';
