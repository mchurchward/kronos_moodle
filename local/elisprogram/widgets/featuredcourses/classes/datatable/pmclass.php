...
class pmclass extends base {
    ...
    public function get_filters() {
        ...
        $enabledfields = get_config('eliswidget_featuredcourses', 'classenabledfields');
    ...
    public function get_datafields_by_visibility(array $filters = array()) {
       ...
       $hidden['enrol_completetime'] = get_string('data_completetime', 'eliswidget_featuredcourses');
