...
(function($) {
     ...
     * Usage:
     *     $('[container selector]').eliswidget_featuredcourses_datatable(options);
     *
     * Required Options:
     ...
     */
    $.fn.eliswidget_featuredcourses_datatable = function(options) {
        this.default_opts = {
            ids: {},
            endpoint: '',
            requestmode: '',
        ...
        this.name = 'featuredcourses_'+opts.ids.widgetid;
    ...
    /**
     * ELIS Featured courses Widget Class Renderer.
     *
     * Usage:
     *     $('[container selector]').eliswidget_featuredcourses_pmclass(data, ids, fieldvisibility, opts);
     *
     * Required Options:
     ...
     */
    $.fn.eliswidget_featuredcourses_pmclass = function(data, ids, fieldvisibility, opts, datatable) {
        return this.each(function() {
            ...
            this.generateid = function(name) {
                return 'eliswidget_featuredcourses'+main.widgetid+'_pgm'+main.programid+'_crs'+main.courseid+'_cls'+main.classid+'_'+name;
            }
    ...
    /**
     * ELIS Featured courses Widget Course Renderer.
     *
     * Usage:
     *     $('[container selector]').eliswidget_featuredcourses_course(data, ids, fieldvisibility, opts);
     *
     * Required Options:
     *     string endpoint The URL to send ajax requests.
     *     object lang     An object of language strings to use throughout the widget.
     ...
     * @return object jQuery object for each instance.
     */
    $.fn.eliswidget_featuredcourses_course = function(data, ids, fieldvisibility, opts, datatable) {
        return this.each(function() {
            var jqthis = $(this);
             ...
             */
            this.generateid = function(name) {
                return 'eliswidget_featuredcourses'+this.widgetid+'_pgm'+main.programid+'_crs'+this.courseid+'_'+name;
            }
            ...
            jqthis.children('.header').click(function() {
                ...
                if (childrenlist.is(':empty') === true) {
                    if (canchooseclasses === true) {
                        ...
                        main.datatable = classlist.eliswidget_featuredcourses_datatable({
                            ...
                            childrenderer: 'eliswidget_featuredcourses_pmclass',
                            childopts: opts,
                            lang: opts.lang
                        });
                        main.datatable.doupdatetable();
    ...
    /**
     * ELIS Featured courses Widget Courseset Renderer.
     *
     * Usage:
     *     $('[container selector]').eliswidget_featuredcourses_courseset(data, ids, fieldvisibility, opts);
     *
     * Required Options:
     *     string endpoint The URL to send ajax requests.
     *     object lang     An object of language strings to use throughout the widget.
     ...
     * @return object jQuery object for each instance.
     */
    $.fn.eliswidget_featuredcourses_courseset = function(data, ids, fieldvisibility, opts, datatable) {
        return this.each(function() {
            var jqthis = $(this);
             ...
             */
            this.generateid = function(name) {
                return 'eliswidget_featuredcourses'+this.widgetid+'_pgm'+main.programid+'_crsset'+this.coursesetid+'_'+name;
            }
            ...
            jqthis.children('.header').click(function() {
                ...
                if (childrenlist.is(':empty') === true) {
                    ...
                    // Initialize datatable.
                    main.datatable = courselist.eliswidget_featuredcourses_datatable({
                        ...
                        childrenderer: 'eliswidget_featuredcourses_course',
                        childopts: opts,
                        lang: opts.lang
                    });
                    main.datatable.doupdatetable();
    ...
    /**
     * ELIS Featured courses Widget Program Renderer
     *
     * Usage:
     *     $('[container selector]').eliswidget_featuredcourses_program(ids, opts);
     *
     * Required Options:
     *     string endpoint The URL to send ajax requests.
     *     object lang     An object of language strings to use throughout the widget.
     ...
     * @return object jQuery object for each instance.
     */
    $.fn.eliswidget_featuredcourses_program = function(ids, opts) {
        return this.each(function() {
            var jqthis = $(this);
             ...
             */
            this.generateid = function(name) {
                return 'eliswidget_featuredcourses'+main.widgetid+'_pgm'+main.programid+'_'+name;
            }
            ...
            jqthis.children('.header').click(function() {
                ...
                if (childrenlist.is(':empty') === true) {
                    if (main.programid !== 'none' && jqthis.data('numcrssets') > 0) {
                        ...
                        // Initialize datatable.
                        main.coursesetdatatable = coursesetlist.eliswidget_featuredcourses_datatable({
                            ids: {programid: main.programid, widgetid: main.widgetid},
                            endpoint: opts.endpoint,
                            requestmode: 'coursesetsforprogram',
                            requestdata: {programid: main.programid},
                            childrenderer: 'eliswidget_featuredcourses_courseset',
                            childopts: opts,
                            lang: opts.lang
                        });
                    ...
                    main.coursedatatable = courselist.eliswidget_featuredcourses_datatable({
                        ids: {programid: main.programid, widgetid: main.widgetid},
                        endpoint: opts.endpoint,
    ...
    /**
     * ELIS Featured courses Widget Initializer
     *
     * Usage:
     *     $('[container selector]').eliswidget_featuredcourses(options);
     *
     * Required Options:
     *     string endpoint The URL to send ajax requests.
     *     object lang     An object of language strings to use throughout the widget.
     ...
     * @return object jQuery object for each instance.
     */
    $.fn.eliswidget_featuredcourses = function(options) {
        return this.each(function() {
            var jqthis = $(this);
            var main = this;
            jqthis.find('div.program').eliswidget_featuredcourses_program({widgetid: jqthis.data('id')}, options);
        });
    }
})(jQuery);