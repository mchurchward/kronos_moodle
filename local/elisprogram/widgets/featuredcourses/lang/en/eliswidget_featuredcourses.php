...
$string['pluginname'] = 'Featured Courses Widget';
$string['name'] = 'Featured Courses';
$string['description'] = 'A widget that only displays featured courses; allowing students to view their learning plans, manage their enrolments, and view their progress.';
$string['action_enrol'] = 'Enrol';
$string['action_leavewaitlist'] = 'Leave';
$string['action_unenrol'] = 'Unenrol';
$string['classes'] = 'Classes:';
$string['courses'] = 'Featured courses:';
...
$string['less'] = '...less';
$string['more'] = 'more...';
$string['no_field_selected'] = 'No fields found';
$string['nonefound'] = 'No courses found';
...
$string['setting_featuredcoursefield'] = 'Featured Courses field';
$string['setting_featuredcoursefield_desc'] = 'Select the Course Description profile field (checkbox) that denotes a featured coures.  Only Courses with the field set will be displayed shown in the widget.';
$string['setting_general_hdr'] = 'General';
