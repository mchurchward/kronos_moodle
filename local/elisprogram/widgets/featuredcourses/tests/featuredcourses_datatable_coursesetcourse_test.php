...
/**
 * Test \eliswidget_featuredcourses\datatable\coursesetcourse.
 * @group eliswidget_featuredcourses
 */
class featuredcourses_datatable_coursesetcourse_testcase extends \elis_database_test {
    /**
    ...
    public function test_get_search_results() {
        ...
        // Run method.
        $datatable = new \eliswidget_featuredcourses\datatable\coursesetcourse($DB, 'http://example.com');
