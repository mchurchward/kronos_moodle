...
/**
 * Test \eliswidget_featuredcourses\datatable\pmclass.
 * @group eliswidget_featuredcourses
 */
class featuredcourses_datatable_pmclass_testcase extends \elis_database_test {
    /**
    ...
    public function test_get_search_results() {
        ...
        // Run method.
        $datatable = new \eliswidget_featuredcourses\datatable\pmclass($DB, 'http://example.com');
