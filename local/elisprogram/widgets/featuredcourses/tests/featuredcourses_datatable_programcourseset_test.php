...
/**
 * Test \eliswidget_featuredcourses\datatable\programcourseset.
 * @group eliswidget_featuredcourses
 */
class featuredcourses_datatable_programcourseset_testcase extends \elis_database_test {
    /**
    ...
    public function test_get_search_results() {
        ...
        // Run method.
        $datatable = new \eliswidget_featuredcourses\datatable\programcourseset($DB, 'http://example.com');
