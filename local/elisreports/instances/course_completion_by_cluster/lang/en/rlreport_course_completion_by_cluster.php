...
$string['column_completeddate'] = 'Completion Date';
$string['column_course'] = 'Course Description';
$string['column_courseidnumber'] = 'Course Idnumber';
...
$string['column_option_courseidnumber'] = 'Course Idnumber';
...
$string['column_user_name'] = 'User\'s Name';
$string['column_username'] = 'Username';
$string['column_userset'] = 'User Set';
...
$string['course_completion_date'] = 'Select the date range for course completions';
$string['course_completion_date_help'] = 'Select the date range for which to show completed course descriptions.';
$string['courses'] = 'Course Descriptions';
$string['courses_help'] = 'Select which Course Descriptions will be shown.';
...
$string['filter_crssetcourses'] = 'Choose Course Descriptions to show';
$string['filter_customfields'] = 'Custom User fields';
$string['filter_customfields_help'] = 'Choose custom user field(s) to show';
$string['filter_groupby'] = 'Choose the elements to group by';
$string['filter_incomplete'] = 'Show incomplete courses';
$string['formatted_grade'] = '{$a}%';
$string['formatted_grade_csv'] = '{$a}';

$string['groupby'] = 'Group by';
$string['groupby_help'] = 'Select which elements you wish to group the results by.';
$string['groupby_option_user_name'] = 'User name';
$string['groupby_option_course_description'] = 'Course Description';
$string['groupby_option_class_completion_date'] = 'Class completion date';
$string['groupby_option_user_set'] = 'User set';
$string['groupby_options_heading'] = 'Group by';

$string['grouping_cluster'] = 'User Set: ';
$string['grouping_completed'] = 'Completed';
$string['grouping_compdate'] = 'Completion Date: ';
$string['grouping_course'] = 'Course: ';
$string['grouping_course_format'] = '{$a->name} ({$a->idnumber})';
$string['grouping_curriculum'] = 'Program: ';
$string['grouping_name'] = 'User Name: ';
...
$string['str_course_completion_date'] = 'Select course completions by how many days, weeks or months ago';
$string['str_course_completion_date_help'] = 'Enter a number and select days, weeks or months to search for course before and after. For example 3 days ago';
$string['stustatus_notcomplete'] = 'Not Completed';
$string['stustatus_notenrolled'] = 'Not Enrolled';
$string['stustatus_passed'] = 'Passed';
$string['stustatus_failed'] = 'Failed';
