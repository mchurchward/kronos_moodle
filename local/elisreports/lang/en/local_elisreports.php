...
$string['confirmjobsdelete'] = 'Are you sure to delete the job(s)?';
$string['confirmjobsdelete_title'] = 'Confirm Delete Jobs';
$string['confirmjobsdelete_unretrieved'] = 'The job(s) has/have attachments that have not been retrieved.<br/>Are you sure to delete the job(s) and all attachments?';
...
$string['listinstancejobs_attachments'] = 'Unretrieved attachments';
