...
YUI.add('moodle-core_filepicker', function(Y) {
    ...
    requires:['base', 'node', 'yui2-treeview', 'yui2-button', 'yui2-menu', 'yui2-cookie', 'yui2-layout', 'yui2-container', 'panel',
            'cookie', 'datatable', 'datatable-sort'] // RL EDIT
});
...
M.core_filepicker.init = function(Y, options) {
    ...
    Y.extend(FilePickerHelper, Y.Base, {
            ...
            if (args.action == 'upload') {
                ...
                for(var k in params) {
                    ...
                    if(value instanceof Array) {
                        for (var i in value) {
                            // RL EDIT - urlencode to prevent mangling of base64 encoded serialized "paths"
       ...
       classnamecallback : function(node) {
        ...
        // RL EDIT
        /**
         * Setter method for the parent path attribute
         * @param string parentpath the parent path to set
         */
        ...
        render: function() {
            ...
            this.mainui = new M.core.dialogue({
                ...
                modal        : true,
                visible      : false,
                width        : '878px', // BJB140107: WAS 873
                responsiveWidth : 878,  // BJB140107: WAS 873
                height       : '558px',
                zIndex       : this.options.zIndex
            });
            ...
            for (var i = 0; i < title_bars.size(); i++) {
                ...
                var closebutton = title_bar.one('.closebutton');
                if (closebutton && closebutton.getStyle('display') != 'none') {
        ...
        list: function(args) {
            ...
            // RL EDIT
            if (args.repo_id == this.get_repo_id(this.options.repositories, 'elisfiles')) {
                this.show_jumpto();
            } else {
                this.hide_jumpto();
            }
        ...
        create_upload_form: function(data) {
            ...
            var content = this.fpnode.one('.fp-content');
            var toelisfiles = (this.options.savepath.substr(0, 1) != "/"); // RL EDIT
            ...
            content.one('.fp-upload-btn').on('click', function(e) {
                ...
                this.hide_header();
                // RL EDIT: BJB130215
                var repoid = scope.active_repo.id;
                if (scope.options.savepath.indexOf('/') == -1) {
                    repoid = this.get_repo_id(this.options.repositories, 'elisfiles');
                }
                // End RL EDIT
                scope.request({
                        scope: scope,
        ...
        // RL EDIT
        /**
         * Obtain the repository type/id
         * @param array repositories array of repositories to check for type
         * @param string type repository type to search for
         * @return int|bool the repository id of type or false if not found
         */
        ...
        print_header: function() {
            var YAHOO = Y.YUI2; // RL EDIT *TBD*: ELIS-8291/ELIS-7858
                    ...
                    advancedsearchbutton.on('click', function(e) {
                        ...
                        scope.request({
                            ...
                            callback: function(id, obj, args) {
                                ...
                                dlg_title.innerHTML = M.str.repository_elisfiles.advancedsearch;
                                ...
                                cattitlediv.innerHTML = '<label>'+M.str.repository_elisfiles.onlyincategories+'</label><br />';
                                ...
                                if (obj.tree.length < 1) {
                                    Y.one('#category-tree-div').set('innerHTML', '<i>'+M.str.repository_elisfiles.nocategoriesfound+'</i>');
                                } else {
        ...
        create_jump_elem: function(jumpnode) {
            ...
            if (!existingjumpnode) {
                var html_locations = '<input type="button" id="locationbutton" name="locationbutton" value="'+M.str.repository_elisfiles.jump+'">';
            ...
            if (p && p.length!=0 && this.viewmode != 2) {
                for(var i = 0; i < p.length; i++) {
                    ...
                    el.on('click',
                            function(e, path) {
                                e.preventDefault();
                                this.refresh_content_and_jump_options([path]); // RL EDIT
                            },
                        this, p[i].path);
                }
